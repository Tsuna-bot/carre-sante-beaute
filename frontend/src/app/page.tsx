    ...
    <div className="min-h-screen bg-white w-full overflow-x-hidden">
      ...
      <section className="relative w-full h-screen bg-black">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-5xl mx-auto px-4 sm:px-6">
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-playfair font-light mb-8 tracking-tight leading-none">
              <span
            ...
            <p
              className="text-lg sm:text-xl md:text-2xl mb-12 font-light max-w-3xl mx-auto leading-relaxed animate-fade-in-up opacity-0"
      ...
      <section className="py-16 sm:py-32 px-4 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 sm:mb-24">
            <h2 className="text-3xl sm:text-5xl md:text-7xl font-playfair font-light text-black mb-8 tracking-tight">
              Produits
              <br />
          ...
          <div className="text-center mt-16">
            <Link
              href="/products"
              className="group inline-flex items-center justify-center px-8 sm:px-12 py-4 sm:py-6 border-2 border-black text-black font-medium hover:bg-black hover:text-white transition-all duration-300 delay-0 ease-out text-base sm:text-lg relative overflow-hidden cursor-pointer"
            >
            ...
            {[
              ...
              <div key={index} className="text-center group">
                ...
                <div className="hidden sm:block bg-gray-100 rounded-lg p-3 sm:p-4 mb-3 group-hover:bg-gray-200 transition-all duration-300 delay-0 ease-out cursor-pointer group-hover:pb-16 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-0 flex space-x-3 sm:space-x-6">
                    <button className="w-8 h-8 sm:w-10 sm:h-10 bg-black text-white rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors cursor-pointer">
                      <svg
      ...
      <section className="py-16 sm:py-32 px-4 sm:px-6 bg-black">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-5xl md:text-7xl font-playfair font-light text-white mb-8 tracking-tight">
            Restez
            <br />
            <span className="font-light">Connecté</span>
          </h2>
          <p className="text-lg sm:text-xl text-gray-400 mb-16 max-w-2xl mx-auto font-light leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 max-w-lg mx-auto">
            <input
              ...
              className="flex-1 px-6 sm:px-8 py-4 sm:py-6 bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:border-white/40 transition-all duration-300 delay-0 ease-out backdrop-blur-sm"
            />
            <button className="px-8 sm:px-12 py-4 sm:py-6 border-2 border-white text-white font-medium hover:bg-white hover:text-black transition-all duration-300 delay-0 ease-out group relative overflow-hidden cursor-pointer">
